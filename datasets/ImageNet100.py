...
class ImageNet100(Dataset):
    def __init__(self, root, split="train", preprocess=None):
        ...
        self._preprocessed_dir = (
            self._data_dir
        )  # Path(root) / "preprocessed_data" / split
        ...
        for file in self._files:
            self._samples.append(
                (
                    self._preprocessed_dir / file.relative_to(self._data_dir),
                    self._typographic_dir / file.relative_to(self._data_dir),
                )
            )
    ...
    def _make_typographic_attack_dataset(self) -> None:
        ...
        for i, file in enumerate(self._files):
            ...
            make_image_text(
                file.relative_to(self._data_dir),
                self.classes,
                self._data_dir,
